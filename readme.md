Bluetooth module robot controled using ATmega16a with modulation a make file is used to compile c files into a proj so it can be turend into a Hex file
# Code in Action
